...
public class Fragment1 extends Fragment {
    ...
    public void onStart()
    {
        ...
        t1=(TextView) context.findViewById(R.id.tv1);
        t2=(TextView) context.findViewById(R.id.tv2);
        t3=(TextView) context.findViewById(R.id.text1) ;
        t4=(TextView) context.findViewById(R.id.text22);
        prev=(Button) context.findViewById(R.id.bt1);
        next=(Button) context.findViewById(R.id.bt2);

        name=getResources().getStringArray(R.array.dua_name);
        dua=getResources().getStringArray(R.array.dua);
